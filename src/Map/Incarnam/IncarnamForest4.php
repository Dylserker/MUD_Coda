...
class IncarnamForest4 extends Blueprint
{
    ...
    public function name(): string { return 'Incarnam - Forêt 4'; }
    public function description(): string { return 'Forêt numéro 4 d\'Incarnam.'; }
