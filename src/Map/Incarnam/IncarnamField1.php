...
class IncarnamField1 extends Blueprint
{
    ...
    public function name(): string { return 'Incarnam - Champ 1'; }
    public function description(): string { return 'Champ numéro 1 d\'Incarnam.'; }
