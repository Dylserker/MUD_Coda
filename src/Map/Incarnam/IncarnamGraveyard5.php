...
class IncarnamGraveyard5 extends Blueprint
{
    ...
    public function name(): string { return 'Incarnam - Cimetière 5'; }
    public function description(): string { return 'Cimetière numéro 5 d\'Incarnam.'; }
