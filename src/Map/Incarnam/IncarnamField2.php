...
class IncarnamField2 extends Blueprint
{
    ...
    public function name(): string { return 'Incarnam - Champ 2'; }
    public function description(): string { return 'Champ numéro 2 d\'Incarnam.'; }
