...
class IncarnamField5 extends Blueprint
{
    ...
    public function name(): string { return 'Incarnam - Champ 5'; }
    public function description(): string { return 'Champ numéro 5 d\'Incarnam.'; }
